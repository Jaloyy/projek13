...
<link rel="stylesheet" type="text/css" href="bootstrap-5.3.8/css/bootstrap.css">
...
<input type="radio" name="jenisKelamin" value="Pria"
    <?= (isset($row1['jenisKelamin']) && $row1['jenisKelamin'] == 'Pria') ? 'checked' : ''; ?>>
Pria
<br>
<input type="radio" name="jenisKelamin" value="Wanita"
    <?= (isset($row1['jenisKelamin']) && $row1['jenisKelamin'] == 'Wanita') ? 'checked' : ''; ?>>
Wanita
<br>
Status Keluarga
<br>
<input type="radio" name="statusKeluarga" value="Belum Menikah"
    <?= (isset($row1['statusKeluarga']) && $row1['statusKeluarga'] == 'Belum Menikah') ? 'checked' : ''; ?>>
Belum Menikah
<br>
<input type="radio" name="statusKeluarga" value="Menikah"
    <?= (isset($row1['statusKeluarga']) && $row1['statusKeluarga'] == 'Menikah') ? 'checked' : ''; ?>>
Menikah
<br>
Hobi
<br>
